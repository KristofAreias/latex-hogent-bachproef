...
De experimenten onderzochten de impact van fine-tuning van YOLO11s op SKU-110K, de impact van fine-tuning van CLIP op OpenFoodFacts, verschillende combinaties van CLIP-, OCR- en Florence-2-embeddings, de invloed van verschillende embeddinggewichten en achtergrondverwijdering als mogelijke verbetering van productmatching. 
