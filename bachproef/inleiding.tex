...
\begin{itemize}
    ...
    \item Hoe verschillen YOLOv8 en Grounding-DINO in termen van mAP, recall en detectiesnelheid bij identieke supermarktbeelden?
    \item Wat is het effect van beperkte fine-tuning op mAP- en SKU-level accuracy ten opzichte van het vooraf getrainde basismodel?
\end{itemize}
