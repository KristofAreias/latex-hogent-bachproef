...
\begin{itemize}
    \item Het model moet een mAP-score behalen op de testdataset van minstens 85 procent.
    \item Het model moet een hoge recall behalen van minstens 80 procent, aangezien het missen van producten vermeden moet worden.
    \item Het model moet een hoge precision behalen die minstens 85 procent bedraagt, aangezien het model accuraat moet zijn over de herkenning van de producten.
    \item Voor classificatie moet een hoge Top-1 accuracy worden nagestreefd die een drempelwaarde heeft van minstens 85 procent.
