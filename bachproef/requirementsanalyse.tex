...
Op basis van prestatiedrempels kunnen we modellen objectief vergelijken. Het is moeilijk om al vaste waarden te geven voor de drempels, daarom zullen we simpelweg een top 3 houden. Als de waarden ondermaats scoren op basis van de andere modelscores zal dit model niet meegenomen worden verder in deze proef. We kiezen onze top 3 modellen op basis van volgende criteria:
\begin{itemize}
